		...
		<table border="1">
			...
			<tr>
				 ...
				 <td>
					<div align="center">
						<span>
							<img src="images/edt.gif" width="16" height="16" /><a href="<?php echo '../example15/empUpdate.php?e_id='.$row['e_id'] ?>">编辑</a>&nbsp; &nbsp;
							<a href="<?php echo '../example15/empDel.php?e_id='.$row['e_id'] ?>"><img src="images/del.gif" width="16" height="16" />删除</a>
						</span>
					</div>
				</td>
			</tr>
